...
class PropertyDetailsViewBody extends StatefulWidget {
  ...
  @override
  State<PropertyDetailsViewBody> createState() => _PropertyDetailsViewBodyState();
}
            ...
            child: Column(
              children: [
                ...
                Align(
                  ...
                  child: Text(
                    type,
                    style: Style.textStyle32.copyWith(color: Color1.white),
                  ),
                ),
                const SizedBox(
                  height: 5,
                ...
                Align(
                  ...
                  child: Text(
                    location,
                    style: Style.textStyle18.copyWith(color: Color1.white),
                  ),
                ),
                const SizedBox(
                  height: 20,
                ...
                Text('Include all taxes',
                    style: Style.textStyle18.copyWith(color: Colors.white70))
              ],
            ),
          ),
        ],
